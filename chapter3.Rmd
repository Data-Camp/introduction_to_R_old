...
`@instructions`
- Divida `all_wars_matrix` por `ticket_prices_matrix` para obter o número estimado de espectadores nos EUA e fora dos EUA para os seis filmes. Atribua o resultado a .
